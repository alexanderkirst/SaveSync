...
| **Saves** | Lists indexed saves with hash preview, size, conflict flag, last modified; **Display name** (main label); **History** sheet per row (revision list, **label save**, **Keep**, restore); quick link to resolve conflicts. |
